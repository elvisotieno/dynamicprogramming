#Consider an elevator system with buttons in the elevator cabin that allow you to go up or down.
#Consider that this lift only travels between two floors to keep things simple.
#There are primarily two possible states for the elevator: 1st floor and 2nd floor.
#The input from the two buttons determines the transition between states
#The elevator performs different actions based on its state.
